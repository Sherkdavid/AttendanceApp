...
public class LocalTestInsert {
	...
	public static void main(String[] args) {
		...
		student.put("student_id", "R001");
		student.put("name", "David Murphy");
		student.put("course_id", "COM");
		student.put("year","1");
		student.put("email", "dmurphy10@mycit.ie");
		try {
			System.out.println(req.sendPostRequest("TestServlet", student));
